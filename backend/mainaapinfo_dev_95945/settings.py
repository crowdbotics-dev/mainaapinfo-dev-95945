"""
Django settings for mainaapinfo_dev_95945 project.
...
ROOT_URLCONF = 'mainaapinfo_dev_95945.urls'
...
WSGI_APPLICATION = 'mainaapinfo_dev_95945.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mainaapinfo_dev_95945 API",
    "DESCRIPTION": "API documentation for mainaapinfo_dev_95945 App",
    "VERSION": "v1",
}
